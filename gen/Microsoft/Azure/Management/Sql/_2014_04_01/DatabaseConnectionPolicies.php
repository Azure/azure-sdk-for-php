...
final class DatabaseConnectionPolicies
{
    /**
    ...
    {
        $this->_Get_operation = $_client->createOperation('DatabaseConnectionPolicies_Get');
        $this->_CreateOrUpdate_operation = $_client->createOperation('DatabaseConnectionPolicies_CreateOrUpdate');
    }
    /**
