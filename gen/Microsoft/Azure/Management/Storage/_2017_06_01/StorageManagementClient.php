...
final class StorageManagementClient
{
    ...
    )
    {
        ...
        $this->_Operations_group = new \Microsoft\Azure\Management\Storage\_2017_06_01\Operations($_client);
        $this->_StorageAccounts_group = new \Microsoft\Azure\Management\Storage\_2017_06_01\StorageAccounts($_client);
        $this->_Usage_group = new \Microsoft\Azure\Management\Storage\_2017_06_01\Usage($_client);
    }
    /**
     * @return \Microsoft\Azure\Management\Storage\_2017_06_01\Operations
     */
    ...
    /**
     * @return \Microsoft\Azure\Management\Storage\_2017_06_01\StorageAccounts
     */
    ...
    /**
     * @return \Microsoft\Azure\Management\Storage\_2017_06_01\Usage
     */
    ...
    /**
     * @var \Microsoft\Azure\Management\Storage\_2017_06_01\Operations
     */
    private $_Operations_group;
    /**
     * @var \Microsoft\Azure\Management\Storage\_2017_06_01\StorageAccounts
     */
    private $_StorageAccounts_group;
    /**
     * @var \Microsoft\Azure\Management\Storage\_2017_06_01\Usage
     */
    ...
    const _SWAGGER_OBJECT_DATA = [
        ...
        'definitions' => [
            ...
            'MetricSpecification' => ['properties' => [
                'name' => ['type' => 'string'],
                'displayName' => ['type' => 'string'],
            ...
            'ServiceSpecification' => ['properties' => ['metricSpecifications' => [
                'type' => 'array',
                'items' => ['$ref' => '#/definitions/MetricSpecification']
            ]]],
            'OperationProperties' => ['properties' => ['serviceSpecification' => ['$ref' => '#/definitions/ServiceSpecification']]],
            ...
            'StorageAccountCheckNameAvailabilityParameters' => ['properties' => [
                'name' => ['type' => 'string'],
                'type' => ['type' => 'string']
            ]],
            ...
            'StorageAccountPropertiesCreateParameters' => ['properties' => [
            ...
            'StorageAccountCreateParameters' => ['properties' => [
            ...
            'StorageAccountListResult' => ['properties' => ['value' => [
                'type' => 'array',
                'items' => ['$ref' => '#/definitions/StorageAccount']
            ]]],
            'StorageAccountListKeysResult' => ['properties' => ['keys' => [
                'type' => 'array',
                'items' => ['$ref' => '#/definitions/StorageAccountKey']
            ]]],
            'StorageAccountRegenerateKeyParameters' => ['properties' => ['keyName' => ['type' => 'string']]],
            'StorageAccountPropertiesUpdateParameters' => ['properties' => [
                'customDomain' => ['$ref' => '#/definitions/CustomDomain'],
                'encryption' => ['$ref' => '#/definitions/Encryption'],
                'accessTier' => [
                    'type' => 'string',
            ...
            'StorageAccountUpdateParameters' => ['properties' => [
                'sku' => ['$ref' => '#/definitions/Sku'],
                'tags' => [
                    'type' => 'object',
                    'additionalProperties' => ['type' => 'string']
            ...
            'AccountSasParameters' => ['properties' => [
                'signedServices' => [
                    'type' => 'string',
                    'enum' => [
                        'b',
            ...
            'ListAccountSasResponse' => ['properties' => ['accountSasToken' => ['type' => 'string']]],
            'ServiceSasParameters' => ['properties' => [
            ...
            'ListServiceSasResponse' => ['properties' => ['serviceSasToken' => ['type' => 'string']]]
        ]
    ];
}
