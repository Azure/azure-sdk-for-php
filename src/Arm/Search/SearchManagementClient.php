 ...
 */
class SearchManagementClient extends RestServiceClient
{
    /**
    ...
    public function __construct($oauthSettings)
    {
        ...
        $this->_adminKeys = new AdminKeys($this);
        $this->_queryKeys = new QueryKeys($this);
        $this->_services = new Services($this);

        $this->setApiVersion('2015-02-28');
    ...
    /**
     * Gets method group AdminKeys.
     *
     * @return AdminKeys
     */
    public function getAdminKeys()
    {
        return $this->_adminKeys;
    }

    /**
     * Gets method group QueryKeys.
     *
     * @return QueryKeys
     */
    ...
    {
        $queryParams = [Resources::API_VERSION => '2015-02-28', 'monitor' => 'true'];
