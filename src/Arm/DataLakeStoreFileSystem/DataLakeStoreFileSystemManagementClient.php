 ...
 */
class DataLakeStoreFileSystemManagementClient extends RestServiceClient
{
    /**
     ...
     * @var string
     */
    private $_adlsFileSystemDnsSuffix;
    /**
     ...
     * @var string
     */
    private $_baseUrl = 'https://{accountName}.{adlsFileSystemDnsSuffix}';
    ...
    public function __construct($oauthSettings)
    {
        ...
        $this->setAdlsFileSystemDnsSuffix('azuredatalakestore.net');
    ...
    /**
     * Gets adlsFileSystemDnsSuffix, the URI used as the base for all cloud
     * service requests.
     *
     * @return string
     */
    public function getAdlsFileSystemDnsSuffix()
    {
        return $this->_adlsFileSystemDnsSuffix;
    }

    /**
     * Sets adlsFileSystemDnsSuffix, the URI used as the base for all cloud
     * service requests.
     *
     * @param string $adlsFileSystemDnsSuffix
     *
     * @return none
     */
    public function setAdlsFileSystemDnsSuffix($adlsFileSystemDnsSuffix)
    {
        $this->_adlsFileSystemDnsSuffix = $adlsFileSystemDnsSuffix;
    }
