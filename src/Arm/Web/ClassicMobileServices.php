...
/**
 * ClassicMobileServices for Use these APIs to manage Azure Websites resources
...
class ClassicMobileServices
{
    ...
    /**
     * Creates a new instance for ClassicMobileServices.
     *
     * @param WebSiteManagementClient, Service client for ClassicMobileServices
     */
     ...
     * </pre>
     */
    public function getClassicMobileServices($resourceGroupName, array $customHeaders = [])
    {
        $response = $this->getClassicMobileServicesAsync($resourceGroupName, $customHeaders);
     ...
     */
    public function getClassicMobileServicesAsync($resourceGroupName, array $customHeaders = [])
    {
     ...
     * </pre>
     */
    public function getClassicMobileService($resourceGroupName, $name, array $customHeaders = [])
    {
        $response = $this->getClassicMobileServiceAsync($resourceGroupName, $name, $customHeaders);
     ...
     * @return \GuzzleHttp\Psr7\Response
     */
    public function getClassicMobileServiceAsync($resourceGroupName, $name, array $customHeaders = [])
    {
        if ($resourceGroupName == null) {
            Validate::notNullOrEmpty($resourceGroupName, '$resourceGroupName');
        }
     ...
     */
    public function deleteClassicMobileService($resourceGroupName, $name, array $customHeaders = [])
    {
        $response = $this->deleteClassicMobileServiceAsync($resourceGroupName, $name, $customHeaders);
     ...
     * @return \GuzzleHttp\Psr7\Response
     */
    public function deleteClassicMobileServiceAsync($resourceGroupName, $name, array $customHeaders = [])
    {
        if ($resourceGroupName == null) {
            Validate::notNullOrEmpty($resourceGroupName, '$resourceGroupName');
        }
