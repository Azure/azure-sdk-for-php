 ...
 */
class DataLakeAnalyticsJobManagementClient extends RestServiceClient
{
    /**
     ...
     * @var string
     */
    private $_baseUrl = 'https://{accountName}.{adlaJobDnsSuffix}';
    ...
    public function __construct($oauthSettings)
    {
        ...
        $this->setApiVersion('2016-03-20-preview');
        $this->setAdlaJobDnsSuffix('azuredatalakeanalytics.net');
    ...
    /**
     * Gets adlaJobDnsSuffix, the DNS suffix used as the base for all Azure
     * Data Lake Analytics Job service requests.
     *
     * @return string
     */
    public function getAdlaJobDnsSuffix()
    {
        return $this->_adlaJobDnsSuffix;
    }

    /**
     * Sets adlaJobDnsSuffix, the DNS suffix used as the base for all Azure
     * Data Lake Analytics Job service requests.
     *
     * @param string $adlaJobDnsSuffix
     *
     * @return none
     */
    public function setAdlaJobDnsSuffix($adlaJobDnsSuffix)
    {
        $this->_adlaJobDnsSuffix = $adlaJobDnsSuffix;
    }
    ...
    {
        $queryParams = [Resources::API_VERSION => '2016-03-20-preview', 'monitor' => 'true'];
