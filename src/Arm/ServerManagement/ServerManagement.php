...
class ServerManagement extends RestServiceClient
{
    ...
    public function __construct($oauthSettings)
    {
        ...
        $this->_powerShell = new PowerShell($this);

        $this->setApiVersion('2015-07-01-preview');
