 ...
 */
class ManagementLockClient extends RestServiceClient
{
    /**
    ...
    /**
     * Method group: ManagementLocks.
     *
     * @var ManagementLocks
     */
    private $_managementLocks;
    ...
    public function __construct($oauthSettings)
    {
        ...
        $this->_managementLocks = new ManagementLocks($this);

        $this->setApiVersion('2015-01-01');
    ...
    /**
     * Gets method group ManagementLocks.
     *
     * @return ManagementLocks
     */
    public function getManagementLocks()
    {
        return $this->_managementLocks;
    }
    ...
    {
        $queryParams = [Resources::API_VERSION => '2015-01-01', 'monitor' => 'true'];
