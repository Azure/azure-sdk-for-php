 ...
 */
class DataLakeAnalyticsCatalogManagementClient extends RestServiceClient
{
    /**
     ...
     * @var string
     */
    private $_baseUrl = 'https://{accountName}.{adlaCatalogDnsSuffix}';
    ...
    public function __construct($oauthSettings)
    {
        ...
        $this->setAdlaCatalogDnsSuffix('azuredatalakeanalytics.net');
    ...
    /**
     * Gets adlaCatalogDnsSuffix, the DNS suffix used as the base for all
     * Azure Data Lake Analytics Catalog service requests.
     *
     * @return string
     */
    public function getAdlaCatalogDnsSuffix()
    {
        return $this->_adlaCatalogDnsSuffix;
    }

    /**
     * Sets adlaCatalogDnsSuffix, the DNS suffix used as the base for all
     * Azure Data Lake Analytics Catalog service requests.
     *
     * @param string $adlaCatalogDnsSuffix
     *
     * @return none
     */
    public function setAdlaCatalogDnsSuffix($adlaCatalogDnsSuffix)
    {
        $this->_adlaCatalogDnsSuffix = $adlaCatalogDnsSuffix;
    }
