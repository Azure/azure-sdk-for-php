 ...
 */
class SqlManagementClient extends RestServiceClient
{
    /**
    ...
    /**
     * Method group: SecurityAlertPolicy.
     *
     * @var SecurityAlertPolicy
     */
    private $_securityAlertPolicy;
    ...
    public function __construct($oauthSettings)
    {
        ...
        $this->_securityAlertPolicy = new SecurityAlertPolicy($this);

        $this->setApiVersion('2015-05-01-preview');
    ...
    /**
     * Gets subscriptionId, The subscription credentials which uniquely
    ...
    /**
     * Sets subscriptionId, The subscription credentials which uniquely
     * identify Microsoft Azure subscription.
     *
    ...
    /**
     * Gets method group SecurityAlertPolicy.
     *
     * @return SecurityAlertPolicy
     */
    public function getSecurityAlertPolicy()
    {
        return $this->_securityAlertPolicy;
    }
    ...
    {
        $queryParams = [Resources::API_VERSION => '2015-05-01-preview', 'monitor' => 'true'];
