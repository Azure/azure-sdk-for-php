 ...
 */
class NotificationHubsManagementClient extends RestServiceClient
{
    /**
    ...
    /**
     * Method group: NotificationHubs.
     *
     * @var NotificationHubs
     */
    private $_notificationHubs;
    ...
    public function __construct($oauthSettings)
    {
        ...
        $this->_namespaces = new Namespaces($this);
        $this->_notificationHubs = new NotificationHubs($this);

        $this->setApiVersion('2014-09-01');
    ...
    /**
     * Gets method group NotificationHubs.
     *
    ...
    {
        $queryParams = [Resources::API_VERSION => '2014-09-01', 'monitor' => 'true'];
