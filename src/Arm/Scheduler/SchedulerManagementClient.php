 ...
 */
class SchedulerManagementClient extends RestServiceClient
{
    /**
    ...
    /**
     * Method group: JobCollections.
     *
     * @var JobCollections
     */
    private $_jobCollections;
    ...
    public function __construct($oauthSettings)
    {
        ...
        $this->_jobCollections = new JobCollections($this);
        $this->_jobs = new Jobs($this);

        $this->setApiVersion('2016-03-01');
    ...
    /**
     * Gets method group JobCollections.
     *
     * @return JobCollections
     */
    public function getJobCollections()
    {
        return $this->_jobCollections;
    }

    /**
     * Gets method group Jobs.
     *
     * @return Jobs
     */
    ...
    {
        $queryParams = [Resources::API_VERSION => '2016-03-01', 'monitor' => 'true'];
