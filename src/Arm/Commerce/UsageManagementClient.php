 ...
 */
class UsageManagementClient extends RestServiceClient
{
    /**
    ...
    /**
     * It uniquely identifes Microsoft Azure subscription. The subscription ID
    ...
    /**
     * Method group: UsageAggregates.
     *
     * @var UsageAggregates
     */
    private $_usageAggregates;

    /**
     * Method group: RateCard.
     *
     * @var RateCard
     */
    private $_rateCard;
    ...
    public function __construct($oauthSettings)
    {
        ...
        $this->_usageAggregates = new UsageAggregates($this);
        $this->_rateCard = new RateCard($this);

        $this->setApiVersion('2015-06-01-preview');
    ...
    /**
     * Gets subscriptionId, It uniquely identifes Microsoft Azure
    ...
    /**
     * Sets subscriptionId, It uniquely identifes Microsoft Azure
     * subscription. The subscription ID forms part of the URI for every
     * service call.
     *
    ...
    /**
     * Gets method group UsageAggregates.
     *
    ...
    {
        $queryParams = [Resources::API_VERSION => '2015-06-01-preview', 'monitor' => 'true'];
