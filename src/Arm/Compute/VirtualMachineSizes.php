...
/**
 * VirtualMachineSizes for The Compute Management Client.
 */
class VirtualMachineSizes
{
    ...
    /**
     * Creates a new instance for VirtualMachineSizes.
     *
     * @param ComputeManagementClient, Service client for VirtualMachineSizes
     */
