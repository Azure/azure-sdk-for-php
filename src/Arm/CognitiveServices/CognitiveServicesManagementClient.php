 ...
 */
class CognitiveServicesManagementClient extends RestServiceClient
{
    /**
    ...
    /**
     * Method group: CognitiveServicesAccounts.
     *
     * @var CognitiveServicesAccounts
     */
    private $_cognitiveServicesAccounts;
    ...
    public function __construct($oauthSettings)
    {
        ...
        $this->_cognitiveServicesAccounts = new CognitiveServicesAccounts($this);

        $this->setApiVersion('2016-02-01-preview');
    ...
    /**
     * Gets method group CognitiveServicesAccounts.
     *
     * @return CognitiveServicesAccounts
     */
    public function getCognitiveServicesAccounts()
    {
        return $this->_cognitiveServicesAccounts;
    }
    ...
    {
        $queryParams = [Resources::API_VERSION => '2016-02-01-preview', 'monitor' => 'true'];
