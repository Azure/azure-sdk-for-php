 ...
 */
class MediaServicesManagementClient extends RestServiceClient
{
    /**
    ...
    /**
     * Method group: MediaServiceOperations.
     *
     * @var MediaServiceOperations
     */
    private $_mediaServiceOperations;
    ...
    public function __construct($oauthSettings)
    {
        ...
        $this->_mediaServiceOperations = new MediaServiceOperations($this);

        $this->setApiVersion('2015-10-01');
    ...
    /**
     * Gets method group MediaServiceOperations.
     *
     * @return MediaServiceOperations
     */
    public function getMediaServiceOperations()
    {
        return $this->_mediaServiceOperations;
    }
    ...
    {
        $queryParams = [Resources::API_VERSION => '2015-10-01', 'monitor' => 'true'];
