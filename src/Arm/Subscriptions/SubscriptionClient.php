 ...
 * SubscriptionClient
 */
class SubscriptionClient extends RestServiceClient
{
    /**
    ...
    public function __construct($oauthSettings)
    {
        ...
        $this->_tenants = new Tenants($this);

        $this->setApiVersion('2015-11-01');
    ...
    /**
     * Gets method group Subscriptions.
     *
    ...
    {
        $queryParams = [Resources::API_VERSION => '2015-11-01', 'monitor' => 'true'];
