...
class Subscriptions
{
    ...
    /**
     * Creates a new instance for Subscriptions.
     *
     * @param SubscriptionClient, Service client for Subscriptions
     */
     ...
     * </pre>
     */
    public function listLocations($subscriptionId, array $customHeaders = [])
    {
        $response = $this->listLocationsAsync($subscriptionId, $customHeaders);
     ...
     */
    public function listLocationsAsync($subscriptionId, array $customHeaders = [])
    {
        ...
        $path = strtr($path, ['{subscriptionId}' => $subscriptionId]);
     ...
     * </pre>
     */
    public function get($subscriptionId, array $customHeaders = [])
    {
        $response = $this->getAsync($subscriptionId, $customHeaders);
     ...
     * @return \GuzzleHttp\Psr7\Response
     */
    public function getAsync($subscriptionId, array $customHeaders = [])
    {
        if ($subscriptionId == null) {
            Validate::notNullOrEmpty($subscriptionId, '$subscriptionId');
        }
