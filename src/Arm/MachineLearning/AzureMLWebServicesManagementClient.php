 ...
 */
class AzureMLWebServicesManagementClient extends RestServiceClient
{
    /**
    ...
    /**
     * The versiong of the Microsoft.MachineLearning resource provider API to
     * be used.
     *
     * @var string
     */
    ...
    public function __construct($oauthSettings)
    {
        ...
        $this->_webServices = new WebServices($this);

        $this->setApiVersion('2016-05-01-preview');
    ...
    /**
     * Gets apiVersion, The versiong of the Microsoft.MachineLearning resource
    ...
    /**
     * Sets apiVersion, The versiong of the Microsoft.MachineLearning resource
     * provider API to be used.
     *
    ...
    {
        $queryParams = [Resources::API_VERSION => '2016-05-01-preview', 'monitor' => 'true'];
