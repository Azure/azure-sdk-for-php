 ...
 */
class EngagementManagementClient extends RestServiceClient
{
    /**
    ...
    /**
     * Method group: AppCollections.
     *
     * @var AppCollections
     */
    private $_appCollections;
    ...
    /**
     * Method group: SupportedPlatforms.
     *
     * @var SupportedPlatforms
     */
    private $_supportedPlatforms;

    /**
     * Method group: Campaigns.
     *
     * @var Campaigns
     */
    private $_campaigns;
    ...
    /**
     * Method group: ImportTasks.
     *
     * @var ImportTasks
     */
    private $_importTasks;
    ...
    public function __construct($oauthSettings)
    {
        ...
        $this->_appCollections = new AppCollections($this);
        $this->_apps = new Apps($this);
        $this->_supportedPlatforms = new SupportedPlatforms($this);
        $this->_campaigns = new Campaigns($this);
        $this->_devices = new Devices($this);
        $this->_exportTasks = new ExportTasks($this);
        $this->_importTasks = new ImportTasks($this);

        $this->setApiVersion('2014-12-01');
    ...
    /**
     * Gets resourceGroupName, The name of the resource group.
     *
     * @return string
     */
    ...
    /**
     * Sets resourceGroupName, The name of the resource group.
     *
    ...
    /**
     * Gets appCollection, Application collection.
     *
     * @return string
     */
    ...
    /**
     * Sets appCollection, Application collection.
     *
     * @param string $appCollection
     *
     * @return none
     */
    public function setAppCollection($appCollection)
    {
        $this->_appCollection = $appCollection;
    }

    /**
     * Gets appName, Application resource name.
     *
     * @return string
     */
    ...
    /**
     * Sets appName, Application resource name.
     *
    ...
    /**
     * Gets method group AppCollections.
     *
    ...
    /**
     * Gets method group SupportedPlatforms.
     *
    ...
    {
        $queryParams = [Resources::API_VERSION => '2014-12-01', 'monitor' => 'true'];
