 ...
 */
class BatchManagementClient extends RestServiceClient
{
    /**
    ...
    /**
     * A unique identifier of a Microsoft Azure subscription. The subscription
    ...
    /**
     * Method group: ApplicationOperations.
     *
     * @var ApplicationOperations
     */
    private $_applicationOperations;

    /**
     * Method group: Subscription.
     *
     * @var Subscription
     */
    ...
    public function __construct($oauthSettings)
    {
        ...
        $this->_applicationOperations = new ApplicationOperations($this);
        $this->_subscription = new Subscription($this);

        $this->setApiVersion('2015-12-01');
    ...
    /**
     * Gets subscriptionId, A unique identifier of a Microsoft Azure
    ...
    /**
     * Sets subscriptionId, A unique identifier of a Microsoft Azure
     * subscription. The subscription id forms part of the URI for every
     * service call.
     *
    ...
    /**
     * Gets method group ApplicationOperations.
     *
     * @return ApplicationOperations
     */
    public function getApplicationOperations()
    {
        return $this->_applicationOperations;
    }

    /**
     * Gets method group Subscription.
     *
     * @return Subscription
     */
    ...
    {
        $queryParams = [Resources::API_VERSION => '2015-12-01', 'monitor' => 'true'];
