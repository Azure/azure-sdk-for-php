 ...
 */
class LogicManagementClient extends RestServiceClient
{
    /**
    ...
    /**
     * Method group: IntegrationAccounts.
     *
     * @var IntegrationAccounts
     */
    private $_integrationAccounts;

    /**
     * Method group: IntegrationAccountSchemas.
     *
     * @var IntegrationAccountSchemas
     */
    private $_integrationAccountSchemas;

    /**
     * Method group: IntegrationAccountMaps.
     *
     * @var IntegrationAccountMaps
     */
    private $_integrationAccountMaps;

    /**
     * Method group: IntegrationAccountPartners.
     *
     * @var IntegrationAccountPartners
     */
    private $_integrationAccountPartners;

    /**
     * Method group: IntegrationAccountAgreements.
     *
     * @var IntegrationAccountAgreements
     */
    private $_integrationAccountAgreements;

    /**
     * Method group: IntegrationAccountCertificates.
     *
     * @var IntegrationAccountCertificates
     */
    private $_integrationAccountCertificates;
    ...
    public function __construct($oauthSettings)
    {
        ...
        $this->_integrationAccounts = new IntegrationAccounts($this);
        $this->_integrationAccountSchemas = new IntegrationAccountSchemas($this);
        $this->_integrationAccountMaps = new IntegrationAccountMaps($this);
        $this->_integrationAccountPartners = new IntegrationAccountPartners($this);
        $this->_integrationAccountAgreements = new IntegrationAccountAgreements($this);
        $this->_integrationAccountCertificates = new IntegrationAccountCertificates($this);

        $this->setApiVersion('2015-08-01-preview');
    ...
    /**
     * Gets apiVersion, The API version.
     *
     * @return string
     */
    ...
    /**
     * Sets apiVersion, The API version.
     *
    ...
    /**
     * Gets method group IntegrationAccounts.
     *
     * @return IntegrationAccounts
     */
    public function getIntegrationAccounts()
    {
        return $this->_integrationAccounts;
    }

    /**
     * Gets method group IntegrationAccountSchemas.
     *
     * @return IntegrationAccountSchemas
     */
    public function getIntegrationAccountSchemas()
    {
        return $this->_integrationAccountSchemas;
    }

    /**
     * Gets method group IntegrationAccountMaps.
     *
     * @return IntegrationAccountMaps
     */
    public function getIntegrationAccountMaps()
    {
        return $this->_integrationAccountMaps;
    }

    /**
     * Gets method group IntegrationAccountPartners.
     *
     * @return IntegrationAccountPartners
     */
    public function getIntegrationAccountPartners()
    {
        return $this->_integrationAccountPartners;
    }

    /**
     * Gets method group IntegrationAccountAgreements.
     *
     * @return IntegrationAccountAgreements
     */
    public function getIntegrationAccountAgreements()
    {
        return $this->_integrationAccountAgreements;
    }

    /**
     * Gets method group IntegrationAccountCertificates.
     *
     * @return IntegrationAccountCertificates
     */
    public function getIntegrationAccountCertificates()
    {
        return $this->_integrationAccountCertificates;
    }
    ...
    {
        $queryParams = [Resources::API_VERSION => '2015-08-01-preview', 'monitor' => 'true'];
