...
class IntegrationAccountPartners
{
    ...
    /**
     * Creates a new instance for IntegrationAccountPartners.
     *
     * @param LogicManagementClient, Service client for IntegrationAccountPartners
     */
     ...
     * </pre>
     */
    public function get($resourceGroupName, $integrationAccountName, $partnerName, array $customHeaders = [])
    {
        $response = $this->getAsync($resourceGroupName, $integrationAccountName, $partnerName, $customHeaders);
     ...
     * @return \GuzzleHttp\Psr7\Response
     */
    public function getAsync($resourceGroupName, $integrationAccountName, $partnerName, array $customHeaders = [])
    {
        if ($this->_client->getSubscriptionId() == null) {
            Validate::notNullOrEmpty($this->_client->getSubscriptionId(), '$this->_client->getSubscriptionId()');
        }
        ...
        if ($partnerName == null) {
            Validate::notNullOrEmpty($partnerName, '$partnerName');
        }
        if ($this->_client->getApiVersion() == null) {
            Validate::notNullOrEmpty($this->_client->getApiVersion(), '$this->_client->getApiVersion()');
        }
        ...
        $path = strtr($path, ['{subscriptionId}' => $this->_client->getSubscriptionId(), '{resourceGroupName}' => $resourceGroupName, '{integrationAccountName}' => $integrationAccountName, '{partnerName}' => $partnerName]);
     ...
     * @param string $integrationAccountName The integration account name.
     * @param string $partnerName The integration account partner name.
     * @param array $partner The integration account partner. 
     * <pre>
     * [
     *    'properties' => [
     *       'partnerType' => 'NotSpecified|B2B',
     ...
     * </pre>
     */
    public function createOrUpdate($resourceGroupName, $integrationAccountName, $partnerName, array $partner, array $customHeaders = [])
    {
        $response = $this->createOrUpdateAsync($resourceGroupName, $integrationAccountName, $partnerName, $partner, $customHeaders);
     ...
     * @return \GuzzleHttp\Psr7\Response
     */
    public function createOrUpdateAsync($resourceGroupName, $integrationAccountName, $partnerName, array $partner, array $customHeaders = [])
    {
        if ($this->_client->getSubscriptionId() == null) {
            Validate::notNullOrEmpty($this->_client->getSubscriptionId(), '$this->_client->getSubscriptionId()');
        }
        ...
        if ($partner == null) {
            Validate::notNullOrEmpty($partner, '$partner');
        }
        ...
        $body = $this->_client->getDataSerializer()->serialize($partner);
     ...
     */
    public function delete($resourceGroupName, $integrationAccountName, $partnerName, array $customHeaders = [])
    {
        $response = $this->deleteAsync($resourceGroupName, $integrationAccountName, $partnerName, $customHeaders);
     ...
     * @return \GuzzleHttp\Psr7\Response
     */
    public function deleteAsync($resourceGroupName, $integrationAccountName, $partnerName, array $customHeaders = [])
    {
        if ($this->_client->getSubscriptionId() == null) {
            Validate::notNullOrEmpty($this->_client->getSubscriptionId(), '$this->_client->getSubscriptionId()');
        }
