...
class AuthorizationManagementClient extends RestServiceClient
{
    ...
    /**
     * Method group: ClassicAdministrators.
     *
     * @var ClassicAdministrators
     */
    private $_classicAdministrators;
    ...
    /**
     * Method group: ProviderOperationsMetadataOperations.
     *
     * @var ProviderOperationsMetadataOperations
     */
    private $_providerOperationsMetadataOperations;

    /**
     * Method group: RoleAssignments.
     *
     * @var RoleAssignments
     */
    ...
    public function __construct($oauthSettings)
    {
        ...
        $this->_classicAdministrators = new ClassicAdministrators($this);
        $this->_permissions = new Permissions($this);
        $this->_providerOperationsMetadataOperations = new ProviderOperationsMetadataOperations($this);
        $this->_roleAssignments = new RoleAssignments($this);
        $this->_roleDefinitions = new RoleDefinitions($this);

        $this->setApiVersion('2015-07-01');
    ...
    /**
     * Gets method group ClassicAdministrators.
     *
     * @return ClassicAdministrators
     */
    public function getClassicAdministrators()
    {
        return $this->_classicAdministrators;
    }

    /**
     * Gets method group Permissions.
     *
     * @return Permissions
     */
    ...
    /**
     * Gets method group ProviderOperationsMetadataOperations.
     *
     * @return ProviderOperationsMetadataOperations
     */
    public function getProviderOperationsMetadataOperations()
    {
        return $this->_providerOperationsMetadataOperations;
    }

    /**
     * Gets method group RoleAssignments.
     *
    ...
    /**
     * Gets method group RoleDefinitions.
     *
    ...
    {
        $queryParams = [Resources::API_VERSION => '2015-07-01', 'monitor' => 'true'];
