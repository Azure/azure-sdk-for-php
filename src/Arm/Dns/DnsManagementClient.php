 ...
 * DnsManagementClient
 */
class DnsManagementClient extends RestServiceClient
{
    /**
    ...
    public function __construct($oauthSettings)
    {
        ...
        $this->_recordSets = new RecordSets($this);
