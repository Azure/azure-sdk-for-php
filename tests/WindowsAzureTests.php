   ...
   function($class) {
      ...
      if ($classes === null) {
         $classes = array(
            ...
            'tests\\unit\\windowsazure\\servicemanagement\\models\\hostedservicepropertiestest' => '/unit/WindowsAzure/ServiceManagement/Models/HostedServicePropertiesTest.php',
