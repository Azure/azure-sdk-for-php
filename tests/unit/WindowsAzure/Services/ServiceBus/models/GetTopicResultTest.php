 ...
 * @link      http://pear.php.net/package/azure-sdk-for-php
 */
class GetTopicResultTest extends \PHPUnit_Framework_TestCase
{
    /**
     * @covers WindowsAzure\Services\ServiceBus\Models\GetTopicResult::__construct
     */
    public function testGetTopicResultConstructor()
    {
        // Setup
        $wrapAccessTokenResult = new WrapAccessTokenResult();
        
        // Test
        $getTopicResult = new GetTopicResult($wrapAccessTokenResult);
