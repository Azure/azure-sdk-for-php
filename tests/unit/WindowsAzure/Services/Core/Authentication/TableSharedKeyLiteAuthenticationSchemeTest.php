...
/**
 * Implementation of class TableSharedKeyLiteAuthenticationSchemeTest.
 *
 *
 * PHP version 5
 *
...
use PEAR2\Tests\Mock\WindowsAzure\Services\Core\Authentication\TableSharedKeyLiteAuthenticationSchemeMock;
use PEAR2\WindowsAzure\Resources;
use PEAR2\Tests\Framework\TestResources;

/**
 * Unit tests for TableSharedKeyLiteAuthenticationScheme class.
 *
 * @package    PEAR2\Tests\Unit\WindowsAzure\Services\Core\Authentication
 * @author     Abdelrahman Elogeel <Abdelrahman.Elogeel@microsoft.com>
 * @copyright  2012 Microsoft Corporation
 ...
 * @link       http://pear.php.net/package/azure-sdk-for-php
 */
class TableSharedKeyLiteAuthenticationSchemeTest extends \PHPUnit_Framework_TestCase
{
    /**
    * @covers PEAR2\WindowsAzure\Services\Core\Authentication\TableSharedKeyLiteAuthenticationScheme::__construct
    */
    public function test__construct()
    {
        ...
        $mock = new TableSharedKeyLiteAuthenticationSchemeMock(TestResources::ACCOUNT_NAME, TestResources::KEY4);

        $this->assertEquals($expected, $mock->getIncludedHeaders());
    }

    /**
    * @covers PEAR2\WindowsAzure\Services\Core\Authentication\TableSharedKeyLiteAuthenticationScheme::computeSignature
    */
    public function testComputeSignatureSimple()
    {
        ...
        $mock = new TableSharedKeyLiteAuthenticationSchemeMock($accountName, TestResources::KEY4);
    ...
    /**
     * @covers PEAR2\WindowsAzure\Services\Core\Authentication\TableSharedKeyLiteAuthenticationScheme::getAuthorizationHeader
     */
    public function testGetAuthorizationHeaderSimple()
    {
        ...
        $mock = new TableSharedKeyLiteAuthenticationSchemeMock($accountName, $accountKey);
