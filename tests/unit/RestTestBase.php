...
class RestTestBase extends PHPUnit_Framework_TestCase
{
    ...
    public function __construct()
    {
        ...
        $this->config->setProperty(QueueConfiguration::ACCOUNT_KEY, TestResources::AZURE_KEY);
        $this->config->setProperty(QueueConfiguration::ACCOUNT_NAME, TestResources::AZURE_ACCOUNT);
        $this->config->setProperty(QueueConfiguration::URI, 'queue.core.windows.net');
